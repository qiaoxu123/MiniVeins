...
/**
 * Stores a Heading in rad, with 0 degrees being east and 90 degrees being
 * north.
 */
class Heading {
public:
    ...
    /**
     * Creates a new Heading from an angle (in rad, with 0 degrees being east and
     * 90 degrees being north).
     */
    ...
    /**
     * Returns the angle (in rad, with 0 degrees being east and 90 degrees being
     * north).
     */
    double getRad() const
    {
    ...
    /**
     * @brief Returns Coord of a unit vector (with x pointing east and y pointing
     * south).
    ...
    /**
     * @brief Converts Coord to heading (with x pointing east and y pointing
     * south).
     */
