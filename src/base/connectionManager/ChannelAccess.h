...
#include "src/base/utils/AntennaPosition.h"
#include "src/base/modules/BatteryAccess.h"
#include "src/base/utils/FindModule.h"
#include "src/base/modules/BaseMobility.h"
 ...
 * @ingroup baseModules
 **/
class ChannelAccess : public BatteryAccess, protected ChannelMobilityAccessType {
protected:
