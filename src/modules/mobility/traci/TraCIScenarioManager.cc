...
#include "src/modules/mobility/traci/TraCIConstants.h"
#include "src/modules/mobility/traci/TraCIMobility.h"

using namespace test::TraCIConstants;

using test::TraCIBuffer;
using test::TraCICoord;
using test::TraCIScenarioManager;

Define_Module(test::TraCIScenarioManager);
