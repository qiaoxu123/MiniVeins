...
#include "src/modules/mobility/traci/TraCIScenarioManagerForker.h"
...
using test::TraCILauncher;
using test::TraCIScenarioManagerForker;

Define_Module(test::TraCIScenarioManagerForker);
